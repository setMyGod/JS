...
for (let i of simpsons){
    ...
    divel.innerText = `${i.name} ${i.surname} ${i.age} ${i.info} ${i.photo}`
    divel.style.marginBottom = '20px'// Как застилизовать отдельно имя или фамилию ?
...
for ( i of simpsons){
    ...
    divname.innerText = i.name;


    let divsurname = document.createElement('div');
    divsurname.innerText = i.surname

    let divage = document.createElement('div');
    divage.innerText = i.age

    let divinfo = document.createElement('div');
    divinfo.innerText = i.info

    let img = document.createElement('img');
    img.src = i.photo

    divel.append(divname, divsurname, divage, divinfo, img)
